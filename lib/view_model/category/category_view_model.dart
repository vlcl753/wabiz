...
class CategoryScreenState with _$CategoryScreenState {
  const factory CategoryScreenState(
      ...
      AsyncValue<List<CategoryItemModel>> projectState}) = _CategoryScreenState;
}
...
Future<List<ProjectType>> fetchTypeTabs(Ref ref) async {
  ...
  return [
    ...
    ProjectType(id: 4, type: "출릴병", imagePath: "assets/icons/type/4.svg"),
    ProjectType(id: 5, type: "스포츠와웃도어", imagePath: "assets/icons/type/5.svg"),
